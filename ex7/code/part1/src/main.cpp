 ...
 * File: q3_p1.c
 *
 * Code generated for Simulink model 'q3_p1'.
 *
 * Model version                  : 1.6
 * Simulink Coder version         : 9.7 (R2022a) 13-Nov-2021
 * C/C++ source code generated on : Sun Dec 31 15:25:55 2023
 *
...
#ifndef RTW_HEADER_q3_p1_h_
#define RTW_HEADER_q3_p1_h_
#ifndef q3_p1_COMMON_INCLUDES_
#define q3_p1_COMMON_INCLUDES_
// #include "rtwtypes.h"
// #include "rtw_continuous.h"
// #include "rtw_solver.h"
#endif                                 /* q3_p1_COMMON_INCLUDES_ */

// #include "q3_p1_types.h"
/*
 * File: q3_p1_types.h
 *
 * Code generated for Simulink model 'q3_p1'.
...
#ifndef RTW_HEADER_q3_p1_types_h_
#define RTW_HEADER_q3_p1_types_h_

/* Model Code Variants */

/* Parameters (default storage) */
typedef struct P_q3_p1_T_ P_q3_p1_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_q3_p1_T RT_MODEL_q3_p1_T;

#endif                                 /* RTW_HEADER_q3_p1_types_h_ */
...
/* Parameters (default storage) */
struct P_q3_p1_T_ {
  real_T Gain_Gain;                    /* Expression: 2.9137e-04
                                        * Referenced by: '<S1>/Gain'
                                        */
  real_T UnitDelay_InitialCondition;   /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay'
                                        */
  real_T b1_Gain;                      /* Expression: 4
                                        * Referenced by: '<S1>/b1'
                                        */
  real_T UnitDelay1_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay1'
                                        */
  real_T b2_Gain;                      /* Expression: 6
                                        * Referenced by: '<S1>/b2'
                                        */
  real_T UnitDelay2_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay2'
                                        */
  real_T b3_Gain;                      /* Expression: 4
                                        * Referenced by: '<S1>/b3'
                                        */
  real_T UnitDelay3_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay3'
                                        */
  real_T b4_Gain;                      /* Expression: 1
                                        * Referenced by: '<S1>/b4'
                                        */
  real_T UnitDelay7_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay7'
                                        */
  real_T a4_Gain;                      /* Expression: 0.473506452939151
                                        * Referenced by: '<S1>/a4'
                                        */
  real_T UnitDelay5_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay5'
                                        */
  real_T a3_Gain;                      /* Expression: -2.24604368202622
                                        * Referenced by: '<S1>/a3'
                                        */
  real_T UnitDelay6_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay6'
                                        */
  real_T a2_Gain;                      /* Expression: 4.03376839272126
                                        * Referenced by: '<S1>/a2'
                                        */
  real_T UnitDelay4_InitialCondition;  /* Expression: 0
                                        * Referenced by: '<S1>/Unit Delay4'
                                        */
  real_T a1_Gain;                      /* Expression: -3.2565693109588
                                        * Referenced by: '<S1>/a1'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_q3_p1_T {
  const char_T * volatile errorStatus;
};

/* Block parameters (default storage) */
extern P_q3_p1_T q3_p1_P;

/* Block states (default storage) */
extern DW_q3_p1_T q3_p1_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_q3_p1_T q3_p1_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_q3_p1_T q3_p1_Y;

/* Model entry point functions */
extern void q3_p1_initialize(void);
extern void q3_p1_step(void);
extern void q3_p1_terminate(void);

/* Real-time Model object */
extern RT_MODEL_q3_p1_T *const q3_p1_M;
...
/* External inputs (root inport signals with default storage) */
ExtU_q3_p1_T q3_p1_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_q3_p1_T q3_p1_Y;

/* Real-time model */
static RT_MODEL_q3_p1_T q3_p1_M_;
RT_MODEL_q3_p1_T *const q3_p1_M = &q3_p1_M_;

/* Model step function */
void q3_p1_step(void)
{
  real_T rtb_Gain;
   ...
   *  Inport: '<Root>/Input'
   */
  rtb_Gain = q3_p1_P.Gain_Gain * q3_p1_U.Input;

  /* UnitDelay: '<S1>/Unit Delay' */
  rtb_UnitDelay = q3_p1_DW.UnitDelay_DSTATE;

  /* UnitDelay: '<S1>/Unit Delay1' */
  rtb_UnitDelay1 = q3_p1_DW.UnitDelay1_DSTATE;

  /* UnitDelay: '<S1>/Unit Delay2' */
  rtb_UnitDelay2 = q3_p1_DW.UnitDelay2_DSTATE;
   ...
   */
  q3_p1_Y.Out1 = ((((q3_p1_P.b3_Gain * q3_p1_DW.UnitDelay2_DSTATE +
                     q3_p1_P.b4_Gain * q3_p1_DW.UnitDelay3_DSTATE) +
                    q3_p1_P.b2_Gain * q3_p1_DW.UnitDelay1_DSTATE) +
                   q3_p1_P.b1_Gain * q3_p1_DW.UnitDelay_DSTATE) + rtb_Gain) -
    (((q3_p1_P.a4_Gain * q3_p1_DW.UnitDelay7_DSTATE + q3_p1_P.a3_Gain *
       q3_p1_DW.UnitDelay5_DSTATE) + q3_p1_P.a2_Gain *
      q3_p1_DW.UnitDelay6_DSTATE) + q3_p1_P.a1_Gain * q3_p1_DW.UnitDelay4_DSTATE);

  /* Update for UnitDelay: '<S1>/Unit Delay' */
  q3_p1_DW.UnitDelay_DSTATE = rtb_Gain;

  /* Update for UnitDelay: '<S1>/Unit Delay1' */
  q3_p1_DW.UnitDelay1_DSTATE = rtb_UnitDelay;

  /* Update for UnitDelay: '<S1>/Unit Delay2' */
  q3_p1_DW.UnitDelay2_DSTATE = rtb_UnitDelay1;

  /* Update for UnitDelay: '<S1>/Unit Delay3' */
  q3_p1_DW.UnitDelay3_DSTATE = rtb_UnitDelay2;

  /* Update for UnitDelay: '<S1>/Unit Delay7' incorporates:
   *  UnitDelay: '<S1>/Unit Delay5'
   */
  q3_p1_DW.UnitDelay7_DSTATE = q3_p1_DW.UnitDelay5_DSTATE;

  /* Update for UnitDelay: '<S1>/Unit Delay5' incorporates:
   *  UnitDelay: '<S1>/Unit Delay6'
   */
  q3_p1_DW.UnitDelay5_DSTATE = q3_p1_DW.UnitDelay6_DSTATE;

  /* Update for UnitDelay: '<S1>/Unit Delay6' incorporates:
   *  UnitDelay: '<S1>/Unit Delay4'
   */
  q3_p1_DW.UnitDelay6_DSTATE = q3_p1_DW.UnitDelay4_DSTATE;

  /* Update for UnitDelay: '<S1>/Unit Delay4' */
  q3_p1_DW.UnitDelay4_DSTATE = q3_p1_Y.Out1;
}

/* Model initialize function */
void q3_p1_initialize(void)
{
  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay' */
  q3_p1_DW.UnitDelay_DSTATE = q3_p1_P.UnitDelay_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay1' */
  q3_p1_DW.UnitDelay1_DSTATE = q3_p1_P.UnitDelay1_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay2' */
  q3_p1_DW.UnitDelay2_DSTATE = q3_p1_P.UnitDelay2_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay3' */
  q3_p1_DW.UnitDelay3_DSTATE = q3_p1_P.UnitDelay3_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay7' */
  q3_p1_DW.UnitDelay7_DSTATE = q3_p1_P.UnitDelay7_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay5' */
  q3_p1_DW.UnitDelay5_DSTATE = q3_p1_P.UnitDelay5_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay6' */
  q3_p1_DW.UnitDelay6_DSTATE = q3_p1_P.UnitDelay6_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay4' */
  q3_p1_DW.UnitDelay4_DSTATE = q3_p1_P.UnitDelay4_InitialCondition;
}

/* Model terminate function */
void q3_p1_terminate(void)
{
